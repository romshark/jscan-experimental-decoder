// Package atoi provides integer parsing functions
// optimized specifically for jscan since the parser validates
// the input before the integer parser is invoked.
//
